...
<html>
    ...
    <body>
        ...
        <div class = "rooms_in_reservation">
            ...
            <?php
                $sql_get_res_id = "select ReservationId FROM tbl_reservation where ReservationConfirmation = 'Rejected'";
                    ...
                    while($row_res_id = $result_res_id->fetch_array())
                    {
                        ...
                        echo "<div class = \"card\">
                                ...
                                <a href = \"modify_rooms_2.php?ReservationId=". $row_res_id['ReservationId'] ."\">
                                    ...
                                    <div class = \"name_mail\">
                                        <a href = \"modify_rejected_res2.php?ReservationId=". $row_res_id['ReservationId'] ."\">
